(define (domain forest)
  ...
  (:action D_1_up-x-1
   ...
   :precondition (and (succ-loc ?loc1x ?loc2x)
		      ...
		      (at-x ?loc1x) (at-y ?loc1y) 
                      (solved ?loc1x ?loc1y))
   :effect (and (at-x ?loc2x) (not (at-x ?loc1x)))
  )
  ...
  (:action D_2_up-x-1
     ...
     :precondition (and (succ-loc ?loc1x ?loc2x)
  		      ...
  		      (at-x ?loc1x) (at-y ?loc1y) 
                        (solved ?loc1x ?loc1y))
     :effect (and (at-y ?loc3y) (not (at-y ?loc1y)))                   
  )
  ...
  (:action D_3_up-x-1
     ...
     :precondition (and (succ-loc ?loc1x ?loc2x)
  		      ...
  		      (at-x ?loc1x) (at-y ?loc1y) 
                        (solved ?loc1x ?loc1y))
     :effect (and (succ-loc ?loc1x ?loc2x)
                        (succ-loc ?loc3y ?loc1y)
  		      (at-x ?loc1x) (at-y ?loc1y) 
                        (solved ?loc1x ?loc1y))
  )
  ...
  (:action D_2_up-x-2
     ...
     :precondition (and (succ-loc ?loc1x ?loc2x)
  		      ...
  		      (at-x ?loc1x) (at-y ?loc1y) 
                        (solved ?loc1x ?loc1y))
     :effect (and (at-y ?loc2y) (not (at-y ?loc1y)))                    
  )
  ...
  (:action D_1_up-y-1
   ...
   :precondition (and (succ-loc ?loc1y ?loc2y)
		      ...
		      (at-x ?loc1x) (at-y ?loc1y) 
	  	      (solved ?loc1x ?loc1y))
   :effect (and (succ-loc ?loc1y ?loc2y)
		      (succ-loc ?loc1x ?loc2x)
		      (at-x ?loc1x) (at-y ?loc1y) 
	  	      (solved ?loc1x ?loc1y))
  )		  
 ...
 (:action D_3_up-y-2
  ...
  (:action D_3_down-x-1
     ...
     :precondition (and (succ-loc ?loc2x ?loc1x)
  		      ...
  		      (at-x ?loc1x) (at-y ?loc1y) 
                        (solved ?loc1x ?loc1y))
     :effect (and (succ-loc ?loc2x ?loc1x)
                        (succ-loc ?loc2y ?loc1y)
  		      (at-x ?loc1x) (at-y ?loc1y) 
                        (solved ?loc1x ?loc1y))
  )
  ...
  (:action D_3_down-y-1
     ...
     :precondition (and (succ-loc ?loc2y ?loc1y)
  		      ...
  		      (at-x ?loc1x) (at-y ?loc1y) 
  	  	      (solved ?loc1x ?loc1y))
     :effect (and (succ-loc ?loc2y ?loc1y)
                        (succ-loc ?loc2x ?loc1x)
  		      (at-x ?loc1x) (at-y ?loc1y) 
  	  	      (solved ?loc1x ?loc1y))
  )
